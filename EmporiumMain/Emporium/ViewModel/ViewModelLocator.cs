...
namespace Emporium.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        //public PasswordResetNumPadViewModel passwordResetNumPadViewModel
        //{
        //    get
        //    {
        //        return ServiceLocator.Current.GetInstance<PasswordResetNumPadViewModel>();
        //    }
        //}
        ...
        public static void RegisterViewModel(ViewModelList register)
        {
            switch (register)
            {
                ...
                case ViewModelList.ConfigNumPad:
                    ...
                    break;
                case ViewModelList.PasswordReset:
                    //if (SimpleIoc.Default.IsRegistered<PasswordResetNumPadViewModel>() == false)
                    //{
                    //    SimpleIoc.Default.Register<PasswordResetNumPadViewModel>();
                    //}
                    break;
                default:
                    break;
